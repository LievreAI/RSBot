...
namespace SDUI
{
    ...
    public class TabStrip : Control
    {
        ...
        /// </summary>
        protected virtual void OnSelectedTabChanged (EventArgs<int> e) => SelectedTabChanged?.Invoke (this, e.Value);
        ...
        public int SelectedIndex {
            ...
            set {
                if (Tabs.SelectedIndex != value) {
                    var oldIndex = Tabs.SelectedIndex;
                    Tabs.SelectedIndex = value;
                    OnSelectedTabChanged (new EventArgs<int>(oldIndex));
