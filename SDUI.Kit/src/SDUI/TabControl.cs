...
namespace SDUI
{
    ...
    public class TabControl : Control
    {
        ...
        public TabControl ()
        {
            tab_strip = base.Controls.AddImplicitControl (new TabStrip {
                Dock = DockStyle.Top
            });
        ...
        /// </summary>
        protected virtual void OnSelectedIndexChanged (int e) => SelectedIndexChanged?.Invoke (this, e);
        ...
        private void TabStrip_SelectedTabChanged (object? sender, int e)
        {
            var old_selected = TabPages.OfType<TabPage> ().FirstOrDefault (tp => tp.Visible);
