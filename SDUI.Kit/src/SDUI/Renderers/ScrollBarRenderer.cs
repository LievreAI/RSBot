    ...
    public class ScrollBarRenderer : Renderer<ScrollBar>
    {
        ...
        protected override void Render (ScrollBar control, PaintEventArgs e)
        {
            ...
            if (thumb_bounds.Width > 0 && thumb_bounds.Height > 0) {
                thumb_bounds.Offset (0, 4);
                thumb_bounds.Inflate (-4, 0);

                e.Canvas.FillRoundedRectangle (thumb_bounds.X, thumb_bounds.Y, thumb_bounds.Width, thumb_bounds.Height, Theme.ControlHighColor);
