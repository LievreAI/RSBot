...
namespace SDUI.Renderers
{
    ...
    public class ToolBarRenderer : Renderer<ToolBar>
    {
        ...
        /// </summary>
        protected virtual void RenderMenuSplitterItem (ToolBar control, MenuSplitterItem item, PaintEventArgs e)
        {
            // Background
        ...
        /// </summary>
        protected virtual Size GetPreferredSplitterItemSize (ToolBar control, MenuSplitterItem item, Size proposedSize)
        {
