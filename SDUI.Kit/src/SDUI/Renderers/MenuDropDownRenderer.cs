...
namespace SDUI.Renderers
{
    ...
    public class MenuDropDownRenderer : Renderer<MenuDropDown>
    {
        ...
        /// </summary>
        protected virtual void RenderMenuSplitterItem (MenuDropDown control, MenuSplitterItem item, PaintEventArgs e)
        {
            // Background
        ...
        /// </summary>
        protected virtual Size GetPreferredSplitterItemSize (MenuDropDown control, MenuSplitterItem item, Size proposedSize)
        {
