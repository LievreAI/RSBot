...
namespace SDUI
{
    ...
    public class TextBox : ScrollControl
    {
        ...
        {
            //base.OnPaint (e);
            //using var paint = new SkiaSharp.SKPaint { FilterQuality = SKFilterQuality.High };
            //paint.Color = SKColors.Red;
            //paint.StrokeWidth = 3;
            //paint.Style = SkiaSharp.SKPaintStyle.StrokeAndFill;

            //e.Canvas.Clear ();
            //e.Canvas.DrawRoundRect (new SkiaSharp.SKRoundRect (ClientRectangle.ToSKRect (), 8), paint);
