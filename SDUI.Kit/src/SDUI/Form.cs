...
namespace SDUI
{
    ...
    public class Form : WindowBase, ICloseable
    {
        ...
        {
            TitleBar = Controls.AddImplicitControl (new UIWindow());

            Resizeable = true;
            Window.SetSystemDecorations (SystemDecorations.None);
            Window.SetExtendClientAreaChromeHints (ExtendClientAreaChromeHints.Default);
            Window.SetExtendClientAreaToDecorationsHint (true);
            Window.SetFrameThemeVariant (PlatformThemeVariant.Dark);
            Window.SetTransparencyLevelHint (new List<WindowTransparencyLevel> { WindowTransparencyLevel.AcrylicBlur });
        ...
        public bool AllowMaximize {
            get => TitleBar.MaximizeBox;
            set => TitleBar.MaximizeBox = value;
        }
        ...
        public bool AllowMinimize {
            get => TitleBar.MinimizeBox;
            set => TitleBar.MinimizeBox = value;
        }
        ...
        /// Displays the window to the user modally, preventing interaction with other windows until closed.
        /// </summary>
        public Task<DialogResult> ShowDialog (Control control)
        {
            return ShowDialog (control.FindForm());
        }
        ...
        public bool UseSystemDecorations {
            ...
            set {
                ...
                if (use_system_decorations != value) {
                    ...
                    Window.SetExtendClientAreaTitleBarHeightHint (64);
                }
            }
        }
