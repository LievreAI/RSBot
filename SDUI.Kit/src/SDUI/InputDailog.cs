...
public partial class InputDialog : Form
{
    ...
    public InputDialog (string formTitle, string title, string message, InputType inputType = InputType.Textbox, object defaultValue = null)
    {
        ...
        switch (_inputType) {
            ...
            case InputType.Numeric:
                ...
                if (defaultValue != null)
                    numValue.Value = Convert.ToSingle (defaultValue);
    ...
    public static Task<DialogResult> Show (string formTitle, string title, string message, InputType inputType)
    {
        var form = new InputDialog (formTitle, title, message, inputType);

        return form.ShowDialog (form);
    }
    ...
    private async void btnOK_Click (object sender, EventArgs e)
    {
        ...
        if (_inputType == InputType.Textbox && string.IsNullOrWhiteSpace (value.ToString ())) {
            await MessageBox.Show (this, "The value can't be empty!");
    ...
    private void InputDialog_FormClosing (object sender, System.ComponentModel.CancelEventArgs e)
    {
