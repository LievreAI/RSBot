...
namespace SDUI
{
    ...
    /// </summary>
    public partial class Control : Component, ILayoutable, IArrangedElement, ISupportInitialize, IDisposable
    {
        #region MIGRATING
        public Font Font { get; set; }
        public Point MouseLocation { get; set; }
        public bool Ripple { get; set; } = false;
        public SKColor[] Gradient { get; set; }
        public bool ApplyGradient { get; set; } = false;
        public bool GradientAnimation { get; set; } = false;
        public bool UseVisualStyleBackColor { get; set; } = false;
        public float ShadowDepth { get; set; } = 0;
        public Padding Radius { get; set; } = new(0);
        public Padding Border { get; set; } = new(0);
        public SKColor ForeColor { get; set; } = SKColors.Black;
        public SKColor BorderColor { get; set; } = SKColors.Transparent;
        public SKColor BackColor { get; set; } = SKColors.Transparent;
        ...
        protected virtual void OnPaint (PaintEventArgs e)
        {
            ...
            (Events[s_paintEvent] as EventHandler<PaintEventArgs>)?.Invoke (this, e);
        }
